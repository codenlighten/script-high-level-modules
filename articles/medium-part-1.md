...
Its three coins are funded on mainnet ([`025f20f1…c5f0`](https://whatsonchain.com/tx/025f20f1d4156aa354afef37b1ec67e5c461f11375bc739902845a3b985dc5f0), block 966,795). The 1,291,329-byte transaction that spends them, [`cad6d2cc…4bb6`](https://whatsonchain.com/tx/cad6d2cca44fffb2f445009f392b668382d79d120b1c14db0fd4a8d192204bb6), is valid, but miners' nodes refuse it for taking too long to validate — about 1.4× as long as the pairing spend that did confirm — so it hasn't been mined. Size limits are per script; this one is per transaction, and the next version has to spread the stages across transactions instead of inputs.
...
| Groth16 verifier with subgroup checks, three inputs of one transaction | 1,291,329-byte transaction | Coins funded on mainnet; spend refused by miners (validation time) |

The limits, stated plainly:

- **No single-script pairing.** Getting there needs another 317,031 bytes cut, about 39%.
...
| Groth16 proof of age, three inputs | [`025f20f1…c5f0`](https://whatsonchain.com/tx/025f20f1d4156aa354afef37b1ec67e5c461f11375bc739902845a3b985dc5f0) | [`cad6d2cc…4bb6`](https://whatsonchain.com/tx/cad6d2cca44fffb2f445009f392b668382d79d120b1c14db0fd4a8d192204bb6) — not mined |
...
**Next, Part II:** a coin that only moves for someone over 21 — and the limit that stopped it from moving.
