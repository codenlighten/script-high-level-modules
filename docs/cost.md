...
| `ecdsa.verify` | arbitrary message, secp256k1 | 82,280 | 45,019 |
...
**`ecdsa.verify` is 82,280 bytes**, the most expensive thing here
...
83 satoshis of fee. Size stopped being the
